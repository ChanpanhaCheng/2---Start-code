...
const STUDENTS_DATA = [
  { firstName: "An", age: 20,lastName:"joe",batch:"batch" },
  { firstName: "Bình", age: 22,lastName:"tt",batch:"batch" },
  { firstName: "Cẩm", age: 21,lastName:"hh",batch:"batch" },
  { firstName: "An", age: 19 ,lastName:"p",batch:"batch"}, // Duplicate first name !
];
...
function AddStudent(firstName,lastName,newAge,batch){
STUDENTS_DATA.push({firstName,lastName,newAge,batch});
}

// 1 - Update An age to 30
updateStudentAge("An","joe", 30,"batch");
AddStudent("kk",'ii',19,"jj");
